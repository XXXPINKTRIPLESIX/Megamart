...
public class CategoryAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<Category>> expandableListDetail;

    public CategoryAdapter(Context context, List<String> expandableListTitle, HashMap<String, List<Category>> expandableListDetail) {
